    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a class="btn btn-primary" href="{{ route('admin.maintenance.types.create') }}">
                ...
                <table class="table table-hover table-striped mb-0 text-center">
                    ...
                    @forelse($types as $type)
                        <tr>
                            ...
                            <td class="align-middle fw-bold">{{ $type->name }}</td>
                            ...
                            <td class="align-middle">
                                <form action="{{ route('admin.maintenance.types.destroy', $type->id) }}" method="POST">
                                    <div class='btn-group'>
                                        <a href="{{ route('admin.maintenance.types.edit', [$type->id]) }}" class='btn btn-outline-primary btn-sm'>
