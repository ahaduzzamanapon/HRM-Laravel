...
<div class="content px-3">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <form action="{{ route('admin.maintenance.vendors.update', $vendor->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="contact_person" id="contact_person" class="form-control" value="{{ old('contact_person', $vendor->contact_person) }}">
                    </div>
                ...
                <div class="card-footer px-0 bg-transparent text-right">
                    <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Update Vendor</button>
