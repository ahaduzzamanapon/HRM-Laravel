...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col-sm-6">
                <h1 class="font-weight-bold"><i class="fa fa-clone mr-2 text-primary"></i>Clone Pension Policy</h1>
                <p class="text-muted">Cloning from source policy: <strong>{{ $sourcePolicy->code }}</strong></p>
            </div>
    ...
    <form method="POST" action="{{ route('admin.pension.policies.store') }}" id="policyForm">
        ...
        <div class="card shadow-sm border-0 bg-white">
            ...
            <div class="card-body p-4">
                <div class="tab-content" id="policyTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="general" role="tabpanel">
                        <h5 class="text-primary font-weight-bold mb-4 border-bottom pb-2">General Information (Cloned copy)</h5>
                        <div class="row">
                            <div class="form-group col-md-4ws">
                                <label class="font-weight-bold">Policy Code <span class="text-danger">*</span></label>
                                <input type="text" name="code" class="form-control" value="{{ $sourcePolicy->code }}-CLONE" required>
                            </div>
                            <div class="form-group col-md-8">
                                <label class="font-weight-bold">Policy Name <span class="text-danger">*</span></label>
                                <input type="text" name="name" class="form-control" value="Copy of {{ $sourcePolicy->name }}" required>
                            </div>
                            <div class="form-group col-md-12">
                                <label class="font-weight-bold">Description</label>
                                <textarea name="description" class="form-control" rows="3">{{ $sourcePolicy->description }}</textarea>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" name="effective_to" class="form-control" value="{{ $sourcePolicy->effective_to }}">
                            </div>
                            <div class="form-group col-md-4">
                                <label class="font-weight-bold">Retirement Age <span class="text-danger">*</span></label>
                                <input type="number" name="retirement_age" class="form-control" value="{{ $sourcePolicy->retirement_age }}" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="font-weight-bold">Min Service Years <span class="text-danger">*</span></label>
                                <input type="number" name="min_service_years" class="form-control" value="{{ $sourcePolicy->min_service_years }}" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="font-weight-bold">Max Service Years <span class="text-danger">*</span></label>
                                <input type="number" name="max_service_years" class="form-control" value="{{ $sourcePolicy->max_service_years }}" required>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <select name="calculation_base" class="form-control" required>
                                    <option value="Last Basic Salary" {{ $sourcePolicy->calculation_base === 'Last Basic Salary' ? 'selected' : '' }}>Last Basic Salary</option>
                                    <option value="Last Gross Salary" {{ $sourcePolicy->calculation_base === 'Last Gross Salary' ? 'selected' : '' }}>Last Gross Salary</option>
                                    <option value="Average Last 12 Months" {{ $sourcePolicy->calculation_base === 'Average Last 12 Months' ? 'selected' : '' }}>Average Last 12 Months</option>
                                    <option value="Average Last 24 Months" {{ $sourcePolicy->calculation_base === 'Average Last 24 Months' ? 'selected' : '' }}>Average Last 24 Months</option>
                                    <option value="Average Last 36 Months" {{ $sourcePolicy->calculation_base === 'Average Last 36 Months' ? 'selected' : '' }}>Average Last 36 Months</option>
                                </select>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="font-weight-bold">Max Pension Percentage (%) <span class="text-danger">*</span></label>
                                <input type="number" step="0.01" name="max_pension_percentage" class="form-control" value="{{ $sourcePolicy->max_pension_percentage }}" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="font-weight-bold">Min Pension Amount (৳) <span class="text-danger">*</span></label>
                                <input type="number" step="0.01" name="min_pension_amount" class="form-control" value="{{ $sourcePolicy->min_pension_amount }}" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="font-weight-bold">Max Pension Amount (৳) <span class="text-danger">*</span></label>
                                <input type="number" step="0.01" name="max_pension_amount" class="form-control" value="{{ $sourcePolicy->max_pension_amount }}" required>
                            </div>
                            <div class="form-group col-md-6 mt-4">
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input type="checkbox" id="early_retirement_allowed" name="early_retirement_allowed" class="custom-control-input" value="1" {{ $sourcePolicy->early_retirement_allowed ? 'checked' : '' }}>
                                ...
                                <div class="custom-control custom-checkbox custom-control-inline ml-4">
                                    <input type="checkbox" id="voluntary_retirement_allowed" name="voluntary_retirement_allowed" class="custom-control-input" value="1" {{ $sourcePolicy->voluntary_retirement_allowed ? 'checked' : '' }}>
                    ...
                    <div class="tab-pane fade" id="eligibility" role="tabpanel">
                        ...
                        @php $el = $sourcePolicy->eligibilityRule; @endphp
                        <div class="row">
                    ...
                    <div class="tab-pane fade" id="schemes" role="tabpanel">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="schemesTable">
                                ...
                                <tbody>
                                    @foreach($sourcePolicy->schemes as $idx => $scheme)
                                    <tr>
                                        <td><input type="text" name="schemes[{{ $idx }}][code]" class="form-control" value="{{ $scheme->code }}-COPY" required></td>
                                        <td><input type="text" name="schemes[{{ $idx }}][name]" class="form-control" value="Copy of {{ $scheme->name }}" required></td>
                                        <td>
                                        ...
                                        <td class="text-center align-middle">
                                            <button type="button" class="btn btn-outline-danger btn-sm delete-row-btn" {{ $sourcePolicy->schemes->count() == 1 ? 'disabled' : '' }}><i class="fa fa-trash"></i></button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                    ...
                    <div class="tab-pane fade" id="formulas" role="tabpanel">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="formulasTable">
                                <thead class="bg-light">
                                    <tr>
                                        <th>Formula Code <span class="text-danger">*</span></th>
                                        <th>Formula Name <span class="text-danger">*</span></th>
                                        <th>Type</th>
                                ...
                                <tbody>
                                    @foreach($sourcePolicy->formulaRules as $idx => $formula)
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <button type="button" class="btn btn-outline-danger btn-sm delete-row-btn" {{ $sourcePolicy->formulaRules->count() == 1 ? 'disabled' : '' }}><i class="fa fa-trash"></i></button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                    ...
                    <div class="tab-pane fade" id="commutation" role="tabpanel">
                        ...
                        @php $com = $sourcePolicy->commutationRule; @endphp
                        <div class="row">
                            <div class="form-group col-md-12">
                        ...
                        <div id="ageBasedFactorsSection" class="mt-4" style="{{ ($com->is_age_based ?? false) ? '' : 'display: none;' }}">
                            ...
                            <div style="max-width: 600px;">
                                <table class="table table-sm table-bordered" id="factorsTable">
                                    ...
                                    <tbody>
                                        @foreach($com->factors ?? [] as $fidx => $factor)
                                        <tr>
                    ...
                    <div class="tab-pane fade" id="gratuity" role="tabpanel">
                        ...
                        @php $grat = $sourcePolicy->gratuityRule; @endphp
                        <div class="row">
                            <div class="form-group col-md-12">
                                <div class="custom-control custom-switch">
                        ...
                        @php $med = $sourcePolicy->medicalRule; @endphp
                        <div class="row">
                            <div class="form-group col-md-4">
                    ...
                    <div class="tab-pane fade" id="family" role="tabpanel">
                        ...
                        @php $fam = $sourcePolicy->familyRule; @endphp
                        <div class="row">
                            <div class="form-group col-md-12">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="family_enabled" name="family[enabled]" value="1" {{ ($fam->enabled ?? false) ? 'checked' : '' }}>
                                    <label class="custom-control-label font-weight-bold" for="family_enabled">Enable Family Pension</label>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="revisionsTable">
                                ...
                                <tbody>
                                    @foreach($sourcePolicy->revisionRules as $ridx => $revision)
                                    <tr>
                    ...
                    <div class="tab-pane fade" id="misc" role="tabpanel">
                        ...
                        @php $tax = $sourcePolicy->taxRule; @endphp
                        <div class="row">
                            <div class="form-group col-md-12">
                                <div class="custom-control custom-switch">
                        ...
                        @php $pay = $sourcePolicy->paymentRule; @endphp
                        <div class="row">
                            <div class="form-group col-md-4">
            ...
            <div class="card-footer bg-light text-right p-4">
                ...
                <button type="submit" class="btn btn-success shadow-sm" id="submitBtn" style="display: none;"><i class="fa fa-save mr-1"></i> Save as New Cloned Policy</button>
            </div>
        </div>
    </form>
</div>
...
<script>
    $(document).ready(function() {
        ...
        // Dynamic Scheme Rows
        var schemeIdx = {{ $sourcePolicy->schemes->count() }};
        ...
        // Dynamic Formulas
        var formulaIdx = {{ $sourcePolicy->formulaRules->count() }};
        ...
        // Dynamic Factors
        var factorIdx = {{ $sourcePolicy->commutationRule->factors->count() ?? 0 }};
        ...
        // Dynamic Revisions
        var revisionIdx = {{ $sourcePolicy->revisionRules->count() }};
