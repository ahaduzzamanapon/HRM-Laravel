            ...
            <form action="{{ route('admin.inventory.assets.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="asset_code" id="asset_code" class="form-control" value="{{ old('asset_code', 'AST-'.strtoupper(uniqid())) }}" required>
                    </div>
                    <div class="col-md-6 form-group">
                    ...
                    <div class="col-md-4 form-group mt-3">
                        ...
                        <input type="number" step="0.01" name="purchase_cost" id="purchase_cost" class="form-control" value="{{ old('purchase_cost') }}">
                    </div>
                    <div class="col-md-4 form-group mt-3">
